...
namespace Utility
{
    ...
    void GetUnicodeFileLines(ifstream &File, suVector<UnicodeString> &Output);
    void GetUnicodeFileLines(const String &Filename, suVector<UnicodeString> &Output, UINT LineLimit = 0);
