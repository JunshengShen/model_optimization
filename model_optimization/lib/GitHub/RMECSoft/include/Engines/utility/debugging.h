...
#else
#define DEBUGGING(level,statements)        \
  if (suDebug::gOnly().isDebug(level)) {   \
    statements                             \
  }
#endif


#if 0 // Version of suDebug that uses values to control debugging

class suDebug
{
public:
  static suDebug& gOnly ();
