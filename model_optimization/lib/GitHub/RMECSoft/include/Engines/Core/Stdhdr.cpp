...
namespace Utility
{
    ...
    void GetClipboardLines(suVector<String> &Output)
    {
        Output.FreeMemory();
    ...
    void GetFileLines(ifstream &File, suVector<String> &Output)
    {
        //Output.FreeMemory();
        suVector<String*> TempOutput;
        string CurLine;
        while(!File.fail())
        {
            getline(File, CurLine);
    ...
    void GetUnicodeFileLines(wifstream &File, suVector<UnicodeString> &Output)
    {
    ...
    void GetFileLines(const String &Filename, suVector<String> &Output)
    {
        ifstream File(Filename.CString());
    ...
    void GetUnicodeFileLines(const String &Filename, suVector<UnicodeString> &Output, UINT LineLimit)
    {
        suVector<BYTE> Data;
    ...
    void GetFileData(const String &Filename, suVector<BYTE> &Output)
    {
