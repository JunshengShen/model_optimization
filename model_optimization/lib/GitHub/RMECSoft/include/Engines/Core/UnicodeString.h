...
public:
    ...
    explicit UnicodeString(const suVector<UnicodeCharacter> &S)
    {
        _Length = S.Length();
        _Capacity = _Length + 1;
    ...
    void Partition(UnicodeCharacter Seperator, suVector<UnicodeString> &Output) const;
    suVector<UnicodeString> Partition(UnicodeCharacter Seperator) const;
    void PartitionAboutIndex(UINT Index, UnicodeString &Left, UnicodeString &Right) const;
    void Partition(const UnicodeString &Seperator, suVector<UnicodeString> &Output) const;
