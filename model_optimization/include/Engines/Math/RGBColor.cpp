...
const RGBColor RGBColor::DarkRed(164, 0, 0);
const RGBColor RGBColor::LightViolet(137, 87, 161);
const RGBColor RGBColor::LightYellowOrange(248, 182, 81);
const RGBColor RGBColor::DarkerRedOrange(127, 45, 0);
const RGBColor RGBColor::PaleWarmBrown(207, 169, 114);
const RGBColor RGBColor::CMYKGreen(0, 153, 68);
const RGBColor RGBColor::LightCyan(0, 183, 238);
