...
template<class T>
void SparseMatrix<T>::Init(const suVector<T> &DiagonalEntries)
{
...
template<class T>
void SparseMatrix<T>::Multiply(suVector<T> &Output, const SparseMatrix<T> &M, const suVector<T> &V)
{
...
template<class T>
void RealVector::Multiply(suVector<T> &Output, T Scale, const suVector<T> &V)
{
...
template<class T>
void RealVector::Multiply(suVector<T> &Output, const suVector<T> &V, T Scale)
{
    Multiply(Output, Scale, V);
}

/*template<class T>
T RealVector::DotProduct(const SparseRow<T> &L, const suVector<T> &R)
{
    T Result = 0.0;
...
template<class T>
T RealVector::DotProduct(const suVector<T> &L, const suVector<T> &R)
{
    T Result = 0.0;
...
template<class T>
void RealVector::Add(suVector<T> &Output, const suVector<T> &L, const suVector<T> &R)
{
...
template<class T>
void RealVector::Subtract(suVector<T> &Output, const suVector<T> &L, const suVector<T> &R)
{
    for(UINT i = 0; i < L.Length(); i++)
    {
        Output[i] = L[i] - R[i];
